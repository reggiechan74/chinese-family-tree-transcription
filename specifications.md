...
#### Vision + Language Models (Stages 1-2)
Required for initial transcription stages:
...
- **Anthropic**:
  ...
  * Token Limits: 8,192 tokens

- **Google**:
  * gemini-2.0-flash-exp
  * gemini-1.5-pro
  * gemini-exp-1206
  * Token Limits: Input handled by API (2M limit), 32,768 output tokens

- **Groq**:
  * llama-3.2-90b-vision-preview
  * Token Limits: Based on model architecture

#### Language-Only Models (Stages 3-8)
For review, translation, and commentary stages:

- **Google**:
  * gemini-pro
  * Token Limits: 32,768 tokens
...
- **Token Limits**:
  ...
  - GPT-4: 4,096 tokens
  - Groq: Model-specific limits

#### FinalStageModel (Stages 5-8)
- **Required Methods**:
  ...
  - generate_commentary()
  - count_tokens()
- **Provider**: Any provider with language-only models
- **Configuration**: Via config.py and environment variables
- **Token Limits**: Based on selected provider/model
...
- **Groq Models**:
  ...
  - No explicit token limit specification needed
