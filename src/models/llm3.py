...
class LLM3Model(BaseModel):
    ...
    def provider(self):
        ...
        if self._provider is None:
            self._provider = ModelFactory.create_model(3)
    ...
    def generate_transcription(self, image: PIL.Image.Image, token_tracker: TokenTracker = None) -> str:
        ...
        try:
            ...
            prompt = format_prompt(Stage2.PROMPT)
            ...
            if token_tracker:
                ...
                token_tracker.add_usage(
                    stage="Stage 2: Secondary Transcription",
                    model="LLM3",
    ...
    def analyze_context(self, context: Dict[str, Any], token_tracker: TokenTracker = None) -> str:
        ...
        try:
            ...
            stage1_transcription = context.get("LLM3's Stage 1 transcription", "")
            stage2_transcription = context.get("LLM3's Stage 2 transcription", "")
